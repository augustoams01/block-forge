                ...
                <div className="flex flex-col gap-56 md:gap-48 lg:gap-80">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="col-span-2">
                            ...
                            <p className="text-xl text-zinc-400 mt-8 lg:text-2xl">BlockForge provides robust and secure infrastructure to support next generation of decentralized applications</p>
                            ...
                            <div className="flex gap-8 mt-12">
                                <CutCornerButton className="block">Get Started</CutCornerButton>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="hidden md:block relative col-san-1">
                            <div className="absolute right-0  z-0">
                                <img src="/assets/images/cone.png" alt="Torus Knot 3d Image" className="size-96 max-w-none rotate-12"/>
                                <img src="/assets/images/hemisphere.png" alt="Hemisphere 3d image" className="absolute size-96 top-3/4 -z-10 left-0"/>
                            </div>
                        </div>
                        <div className="col-span-2">
                            ...
                            <div className="flex flex-col text-xl lg:text-2xl text-zinc-400 mt-6 gap-6">
                                ...
                                <p>Blockforge champions Web3 for everyone. As a decentralized blockchain scaling plataform, Blockforge enables developers to create scalable, user-friendly Apps whit transaction consts, all while ensuring robust security.</p>
                            </div>
                            <div className="inline-flex gap-8 mt-12">
